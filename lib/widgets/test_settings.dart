    ...
    return Column(
      ...
      children: [
        ...
        CheckboxListTile(
          ...
          value: widget.testSettingsData.isShuffleAnswers,
          onChanged: (value) {
            setState(() {
              widget.testSettingsData.isShuffleAnswers = value!;
            });
          },
        ...
        CheckboxListTile(
          ...
          value: widget.testSettingsData.isShuffleQuestions,
          onChanged: (value) {
            setState(() {
              widget.testSettingsData.isShuffleQuestions = value!;
            });
          },
